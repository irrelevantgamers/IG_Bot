...
def watch_game_db():
    while True:
        ...
        gamedbCur.execute(
            "SELECT g.guildid, g.name, count(*) as InventoryCount FROM item_inventory as dsi JOIN buildings as b on dsi.owner_id = b.object_id JOIN guilds as g on b.owner_id = g.guildId GROUP BY g.guildId ORDER BY InventoryCount DESC")
