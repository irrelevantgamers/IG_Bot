...
def WatchForServerSettings():
    while True:
        ...
        try:
            ...
            sys.exit(1)
        dbCur = dbCon.cursor()
        dbCur.execute("SELECT id, buffname, isactive, lastActivated, endTime, lastActivatedBy, deactivateCommand FROM server_buffs WHERE serverName =?",(config.Server_Name, ))
