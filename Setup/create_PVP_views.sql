...
#
CREATE VIEW IF NOT EXISTS {server}_SOLO_PVP_LEADER_ALL AS SELECT RANK() OVER (ORDER BY Kills DESC) AS Place, player, kills, deaths FROM (
...
CREATE VIEW IF NOT EXISTS {server}_SOLO_PVP_LEADER_30Day AS SELECT RANK() OVER (ORDER BY Kills DESC) AS Place, player, kills, deaths FROM (
...
ON player = victim) ORDER BY kills DESC;
CREATE VIEW IF NOT EXISTS {server}_SOLO_PVP_LEADER_7Day AS SELECT RANK() OVER (ORDER BY Kills DESC) AS Place, player, kills, deaths FROM (
...
ON player = victim) ORDER BY kills DESC;
CREATE VIEW IF NOT EXISTS {server}_SOLO_PVP_LEADER_1Day AS SELECT RANK() OVER (ORDER BY Kills DESC) AS Place, player, kills, deaths FROM (
...
#
CREATE VIEW IF NOT EXISTS {server}_CLAN_PVP_LEADER_ALL AS SELECT RANK() OVER (ORDER BY Kills DESC) AS Place, player_clan as Clan, kills, deaths FROM (
...
CREATE VIEW IF NOT EXISTS {server}_CLAN_PVP_LEADER_30Day AS SELECT RANK() OVER (ORDER BY Kills DESC) AS Place, player_clan as Clan, kills, deaths FROM (
...
ON player_clan = victim_clan) ORDER BY kills DESC;
CREATE VIEW IF NOT EXISTS {server}_CLAN_PVP_LEADER_7Day AS SELECT RANK() OVER (ORDER BY Kills DESC) AS Place, player_clan as Clan, kills, deaths FROM (
...
ON player_clan = victim_clan) ORDER BY kills DESC;
CREATE VIEW IF NOT EXISTS {server}_CLAN_PVP_LEADER_1Day AS SELECT RANK() OVER (ORDER BY Kills DESC) AS Place, player_clan as Clan, kills, deaths FROM (
